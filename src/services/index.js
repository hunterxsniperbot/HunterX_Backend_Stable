...
// Phantom → asegurar { buyToken, sellToken } y opcionales { getBalancesUSD, getSolBalance }
...
const phantomClient = {
  ...
  getBalancesUSD : phantomBase.getBalancesUSD || undefined,
  getSolBalance  : phantomBase.getSolBalance  || undefined,
};
